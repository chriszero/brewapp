...
def main():
    ...
    step_player.add_simple_step("Weizenrast", tSensor1, hyst_controller, heater, value=43, time=20 * 60).append(pump_controller)
    step_player.add_simple_step("Maltoserast", tSensor1, hyst_controller, heater, value=63, time=30 * 60).append(pump_controller)
    step_player.add_simple_step("Verzuckerung ", tSensor1, hyst_controller, heater, value=72, time=30 * 60).append(pump_controller)
    ...
    step_player.do_work()  # start process
